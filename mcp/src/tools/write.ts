...
const write = (destructiveHint = false) =>
  ({ readOnlyHint: false, destructiveHint, openWorldHint: false }) as const;
...
const commentOutput = z
  .object({
    ...
    ticket_revision: boundedRevision,
  })
  .strict();
const attachmentWriteOutput = z
  .object({
    id: z.string(),
    ticket_id: z.string(),
    project_id: z.string(),
...
export const writeTools: ToolSpec[] = [
  {
    name: "create_project",
    description: "Create an active project with an immutable key.",
    inputSchema: z
      .object({
        key: z
          .string()
        ...
        name: boundedText.max(200),
        description: optionalDescription.default(""),
      })
      .strict(),
    outputSchema: projectOutputSchema,
    annotations: write(),
    rpcMethod: "projects.create",
    mode: "write",
    resultSchema: Project,
  },
  {
    name: "update_project",
    description:
    ...
    inputSchema: z
      .object({
        project_id: boundedReference,
        expected_revision: boundedRevision,
  ...
  },
  {
    ...
    rpcMethod: "projects.archive",
    mode: "write",
    resultSchema: Project,
  },
  {
    name: "restore_project",
    description: "Restore an archived project using its current revision.",
    inputSchema: z
      .object({
        project_id: boundedReference,
        expected_revision: boundedRevision,
  ...
  },
  {
    ...
    inputSchema: z
      .object({
        project_id: boundedReference,
        title: boundedText.max(500),
        description: optionalDescription.default(""),
        status: status.optional(),
        priority: priority.optional(),
        assignee: assignee.optional(),
        parent_ticket_id: boundedReference.nullable().optional(),
        labels: labels.optional(),
      })
      .strict(),
    outputSchema: ticketOutputSchema,
    annotations: write(),
    rpcMethod: "tickets.create",
    mode: "write",
    resultSchema: TicketSummary,
  },
  {
    name: "update_ticket",
    description: "Update ticket fields and labels using its current revision.",
    inputSchema: z
      .object({
        ticket_id: boundedReference,
        expected_revision: boundedRevision,
        title: boundedText.max(500).optional(),
        description: optionalDescription.optional(),
        priority: priority.optional(),
        assignee: assignee.optional(),
        labels: labels.optional(),
    ...
    outputSchema: ticketOutputSchema,
    annotations: write(),
    rpcMethod: "tickets.update",
    mode: "write",
    resultSchema: TicketSummary,
  },
  {
    name: "transition_ticket",
    description: "Move a ticket to a status using its current revision.",
    inputSchema: z
      .object({
        ticket_id: boundedReference,
        expected_revision: boundedRevision,
  ...
  },
  {
    ...
    inputSchema: z
      .object({ ticket_id: boundedReference, body: boundedText.max(100_000) })
      .strict(),
    outputSchema: commentOutput,
    annotations: write(),
    rpcMethod: "comments.add",
    mode: "write",
    resultSchema: commentResult,
  },
  {
    ...
    inputSchema: z
      ...
      .strict(),
    outputSchema: attachmentWriteOutput,
    annotations: write(),
    rpcMethod: "attachments.add_from_path",
    mode: "write",
    resultSchema: attachmentResult,
  },
  {
    name: "add_dependency",
    description:
    ...
    inputSchema: z
      .object({
        blocked_ticket_id: boundedReference,
        blocker_ticket_id: boundedReference,
        expected_revision: boundedRevision,
      })
      .strict(),
    outputSchema: ticketOutputSchema,
    annotations: write(),
    rpcMethod: "dependencies.add",
    mode: "write",
    resultSchema: TicketSummary,
  },
  {
